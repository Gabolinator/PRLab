...
namespace PRLab.Infrastructure.DB.Migrations
{
    ...
    [Migration("20260613145840_AddWorkTargetsToMovement")]
    partial class AddWorkTargetsToMovement
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PRLab.Domain.Model.Entity.Equipment", b =>
                {
                    ...
                    b.OwnsOne("PRLab.Domain.Value.Ownership.OwnershipInfo", "Ownership", b1 =>
                        {
                            b1.Property<Guid>("EquipmentId")
                                .HasColumnType("uuid");
