...
namespace PRLab.Infrastructure.DB.Migrations
{
    ...
    [Migration("20260618061437_AddLaterabilityMovement")]
    partial class AddLaterabilityMovement
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PRLab.Domain.Model.Value.ExerciseSteps", b =>
                {
                    ...
                    b.OwnsOne("PRLab.Domain.Model.Value.Prescription.RestTarget", "RestBetweenReps", b1 =>
                        {
                            b1.Property<Guid>("ExerciseStepsId")
                                .HasColumnType("uuid");

                            b1.Property<int>("RestPolicy")
                                .HasColumnType("integer");
                    ...
                    b.OwnsOne("PRLab.Domain.Model.Value.Prescription.RestTarget", "TransitionAfterStep", b1 =>
                        {
                            b1.Property<Guid>("ExerciseStepsId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("PRLab.Domain.Model.Value.Prescription.LoadTarget", "LoadTarget", b1 =>
                        {
                            b1.Property<Guid>("ExerciseStepsId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("PRLab.Domain.Model.Value.Prescription.RepExecutionDetails", "ExecutionDetails", b1 =>
                        {
                            b1.Property<Guid>("ExerciseStepsId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("PRLab.Domain.Model.Value.Prescription.WorkTarget", "Target", b1 =>
                        {
                            b1.Property<Guid>("ExerciseStepsId")
                                .HasColumnType("uuid");
